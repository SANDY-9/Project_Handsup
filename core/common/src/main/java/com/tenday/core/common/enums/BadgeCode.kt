...
enum class BadgeCode(
    ...
    EXP_EVERY_MONTH_FOR_A_YEAR(
        ...
        shortDesc = "월간 미션에서 일 년간\n모든 달의 두둥 경험치 획득 시 부여",
